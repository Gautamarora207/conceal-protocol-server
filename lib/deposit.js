 ...
 */
async function createDeposit(nullifier, secret, recipient) {
  try {
...
async function parseNote(noteString, recipient) {
  try {
    const noteRegex =
    ...
    return await createDeposit(nullifier, secret, recipient);
  }
  catch(e) {
    throw e;
  }
